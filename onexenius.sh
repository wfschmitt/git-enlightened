...
do
    ...
    #~ (Configure)
        case $I in
            efl) $GEN --enable-cxx-bindings --enable-image-loader-webp \
...
in Enlightenment? [y/N] " answer
    case $answer in
        [yY] ) rebuild_optim; echo
        ;;
        [nN] ) rebuild_optim_no_nls; echo
        ;;
